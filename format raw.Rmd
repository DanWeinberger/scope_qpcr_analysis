...
prop.table(table(s2_a$child_contact_2weeks, s2_a$piab_pos), margin=1)

prop.table(table(s2_a$child_contact_age___1, s2_a$piab_pos), margin=1)

prop.table(table(s2_a$child_contact_age___2, s2_a$piab_pos), margin=1)

prop.table(table(s2_a$child_contact_age___3, s2_a$piab_pos), margin=1)
           
prop.table(table(s2_a$child_contact_age___4, s2_a$piab_pos), margin=1)

prop.table(table(s2_a$child_contact_age___5, s2_a$piab_pos), margin=1)

mod_s2 <- glm(piab_pos ~ child_contact_age___1 + child_contact_age___2 + child_contact_age___3 + child_contact_age___4 + child_contact_age___5, family='binomial', data=s2_a )
summary(mod_s2)
```
