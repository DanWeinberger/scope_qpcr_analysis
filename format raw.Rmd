...
c1.c <- reshape2::dcast(c1.m, Sample+plate +variable ~ Target, fun.aggregate = min, fill=9999)
...
q1b <- q1b[,c(which(names(q1b) %in% select.colnames.q1),grep('Which symptoms are you experiencing today', names(q1)),grep('Have you had any of the following symptoms', names(q1b))  )]
