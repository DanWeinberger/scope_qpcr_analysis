...
q0.baseline.vars <- c('MRN','scope_id',"pos_covid_past","pos_covid_date","pneu_vax", "pneu_vax_date",'ethnicity','weight','height','education', "immuno_meds" ,"diabetes_meds", "asthma_meds","flu_shot","hh_relationship", "relationship_duration")
...
q1 <- merge(q1, q0[,q0.baseline.vars], by='MRN', all.x=T)
sort(table(q1$MRN))
```
...
```{r}
table1(~piab_pos|recent_ , data= e3 )
...
#table1(~piab_pos|current_smoke, data= e3 )
