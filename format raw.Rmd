...
prop.table(table(s2_data$survey_and_pcr_s2$child_contact_2weeks, s2_data$survey_and_pcr_s2$piab_pos), margin=1)

prop.table(table(s2_data$survey_and_pcr_s2$child_contact_age___1, s2_data$survey_and_pcr_s2$piab_pos), margin=1)

prop.table(table(s2_data$survey_and_pcr_s2$child_contact_age___2, s2_data$survey_and_pcr_s2$piab_pos), margin=1)

prop.table(table(s2_data$survey_and_pcr_s2$child_contact_age___3, s2_data$survey_and_pcr_s2$piab_pos), margin=1)
           
prop.table(table(s2_data$survey_and_pcr_s2$child_contact_age___4, s2_data$survey_and_pcr_s2$piab_pos), margin=1)

prop.table(table(s2_data$survey_and_pcr_s2$child_contact_age___5, s2_data$survey_and_pcr_s2$piab_pos), margin=1)

mod_s2 <- glm(piab_pos ~ child_contact_age___1 + child_contact_age___2 + child_contact_age___3 + child_contact_age___4 + child_contact_age___5, family='binomial', data=s2_data$survey_and_pcr_s2 )
summary(mod_s2)
```
...
Differences by sex
```{r}
table(s1_data$survey_and_pcr_s1$piab_pos, s1_data$survey_and_pcr_s1$Gender)

s1_data$survey_and_pcr_s1 %>%
  filter(piab_pos==1) %>%
  group_by(Gender) %>%
  summarize(mean_ct=mean(piab)) 


piab_men <- s1_data$survey_and_pcr_s1 %>%
  filter(piab_pos==1 & Gender=='M')

piab_women <- s1_data$survey_and_pcr_s1 %>%
...
#CAUTION: look out for missing data and differences i how this is handled in S1 and S2
```{r}

prop.table(table(s1_data$survey_and_pcr_s1$child_contact_u12m))
prop.table(table(s2_data$survey_and_pcr_s2$child_contact_age___1))

prop.table(table(s1_data$survey_and_pcr_s1$child_contact_13_23m))
prop.table(table(s2_data$survey_and_pcr_s2$child_contact_age___2))

prop.table(table(s1_data$survey_and_pcr_s1$child_contact_24_59m))
prop.table(table(s2_data$survey_and_pcr_s2$child_contact_age___3))

prop.table(table(s1_data$survey_and_pcr_s1$child_contact_5_10y))
prop.table(table(s2_data$survey_and_pcr_s2$child_contact_age___4))


prop.table(table(s1_data$survey_and_pcr_s1$child_contact_over10y))
prop.table(table(s2_data$survey_and_pcr_s2$child_contact_age___5))
...
```{r, echo=F}
table1(~piab_pos|child_contact_u12m  , data= s1_data$survey_and_pcr_s1 )
fisher.test(s1_data$survey_and_pcr_s1$piab_pos, s1_data$survey_and_pcr_s1$child_contact_u12m)
```
...
s1_data$survey_and_pcr_s1$child_contact_13_59m <- s1_data$survey_and_pcr_s1$child_contact_13_23m
s1_data$survey_and_pcr_s1$child_contact_13_59m[s1_data$survey_and_pcr_s1$child_contact_24_59m=='Yes'] <- 'Yes'


table1(~piab_pos|child_contact_13_59m  , data= s1_data$survey_and_pcr_s1 )
fisher.test(s1_data$survey_and_pcr_s1$piab_pos, s1_data$survey_and_pcr_s1$child_contact_13_59m)
...
```{r, echo=F}
table1(~piab_pos|child_contact_13_23m  , data= s1_data$survey_and_pcr_s1 )
fisher.test(s1_data$survey_and_pcr_s1$piab_pos, s1_data$survey_and_pcr_s1$child_contact_13_23m)
...
```{r, echo=F}
table1(~piab_pos|child_contact_24_59m  , data= s1_data$survey_and_pcr_s1 )
fisher.test(s1_data$survey_and_pcr_s1$piab_pos, s1_data$survey_and_pcr_s1$child_contact_24_59m)
