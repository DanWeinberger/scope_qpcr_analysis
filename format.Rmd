...
a1$`lyta Repeated 1`[is.na(a1$`lyta Repeated 1`) & !is.na(a1$`DNA Date repeat`)] <- 45

a1$`piaB repeated 1`[is.na(a1$`piaB repeated 1`) & !is.na(a1$`DNA Date repeat`)] <- 45

a1$`lyta Repeated 2`[is.na(a1$`lyta Repeated 2`) & !is.na(a1$`DNA Date repeat`)] <- 45

a1$`piaB repeated 2`[is.na(a1$`piaB repeated 2`) & !is.na(a1$`DNA Date repeat`)] <- 45

a1$pos.initial <- a1$lytA<45 & a1$piaB<45
a1$pos.repeat <- (a1$`lyta Repeated 1`<45 & a1$`piaB repeated 1`<45 ) | (a1$`lyta Repeated 2`<45 & a1$`piaB repeated 2`<45 ) 
